...
* **Cybersecurity**: The registration component uses email validation and strong password rules. Angular is used to prevent XSS (cross site scripting). Passwords are stored securely and never in plaintext. Once you logout, the back button does not take you back to your account.
